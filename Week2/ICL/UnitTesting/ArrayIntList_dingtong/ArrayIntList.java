...
/**
 * An {@code ArrayIntList} class stores an ordered list of integers using an
 * unfilled array.
 * <p>
 * Reference: <a href=
 * "https://courses.cs.washington.edu/courses/cse143/11wi/lectures/01-12/programs/ArrayIntList.java">ArrayIntList.java</a>:
 * UW - CSE 143, Winter 2011
 * 
 * @author Marty Stepp
 * @author Sheila Oh
 *
...
public class ArrayIntList {
	...
	/**
	 * Adds the given value to the end of the list. If necessary, resizes the
	 * array to fit the value.
	 * 
	...
	/**
	 * Inserts the given value into the list at the given index. If necessary,
	 * resizes the array to fit the value.
	 * 
	...
	/**
	 * Sets the given index to store the given value. Assumes that a value
	 * already exists at the given index. is already
	 * 
	 * @custom.pre Index is between 0 and size - 1 (inclusive).
	...
	/**
	 * Returns a String representation of the elements in the list, such as "[42,
	 * -3, 17, 99]", or "[]" for an empty list.
	 * 
	...
	/**
	 * A "private helper method" to resize the array if necessary. Checks whether
	 * the list's array is full, and if so, doubles its size so that more
